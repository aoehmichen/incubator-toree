...
object Common {
  ...
  val commonSettings: Seq[Def.Setting[_]] = Seq(
    ...
    isSnapshot := snapshot,
    resolvers ++= Seq("Typesafe repository" at "http://repo.typesafe.com/typesafe/releases/", "Cloudera repository" at "https://repository.cloudera.com/artifactory/cloudera-repos/"),
    // Test dependencies
